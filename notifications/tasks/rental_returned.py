...
from notifications.messages import message_returned_rental
...
def notify_rental_returned(self, rental_id: int):
    """
    Notify via Telegram when a rental is returned.
    ...
    telegram_message = message_returned_rental(rental)
